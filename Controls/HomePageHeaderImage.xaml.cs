...
public sealed partial class HomePageHeaderImage : UserControl
{
    ...
    // Guard: composition resources are built once and reused across navigations.
    // CreateEffectFactory compiles a GPU shader — too expensive to repeat per navigation.
    private bool _isCompositionReady;
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        if (!_isCompositionReady)
        {
            // Build composition objects once — CreateEffectFactory compiles a GPU shader
            // and is too expensive to repeat on every navigation.
            ...
            _isCompositionReady = true;
        }

        // Re-attach every time the control enters the visual tree (navigation back).
    ...
    {
        // Detach from the visual tree without disposing — resources are reused on next navigation.
